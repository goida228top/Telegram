...
const CamOnIcon = () => (<svg xmlns="http://www.w.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="currentColor"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4z"/></svg>);
    ...
    const consume = async (producerId: string, mediaType: 'video' | 'audio', peerId: string) => {
        ...
        socketRef.current!.emit('consume', { producerId, rtpCapabilities }, async (params: any) => {
            ...
            setRemotePeers(prev => {
                ...
                // Create a new object to ensure React detects the change (immutability)
